...
<!--
Dual-runtime example. Keep this Session Protocol identical to CLAUDE.md.
...
1. Prepend a v2 handoff entry: `## YYYY-MM-DD — [Agent] | Cursor ([IDE|Cloud|CLI]) | code` plus tag-in/tag-out with timezone (prefer UTC).
...
4. If this session is PR-only, paste the newest handoff entry into the PR body.
5. Sign off: "End of Line."
