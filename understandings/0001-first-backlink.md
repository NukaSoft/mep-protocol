...
para: resource
areas: [seo, community]
tags: [area:seo, resource:community, first-dollar, phoenix]
context: "@session"
thread: []
phoenix: true
...
> awesome by the way, is in the trivia section should be the link to his bio page on our
> nukasoft.ai with a really cool thing that says like he also is in a Microsoft developer's
> platform as an agent and then just as an artificial person in a business application or
> something like that and then just have it click to the site and then people click on it.
